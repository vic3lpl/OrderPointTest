...
- (void)viewDidLoad {
	...
	[self.saveButton setTitle:NSLocalizedString(bigBtn, @"Title for save button on numeric keypad") forState:UIControlStateNormal];
...
- (IBAction)buttonPress:(id)sender {
	...
	if (button == self.backButton) {
        ...
        if ([self.delegate respondsToSelector:@selector(keyPressActionFormTextField:)]){
            [self.delegate keyPressActionFormTextField:self.numpadTextField];
