...
+ (NSData *)sampleReceiptWithPaperWidth:(SMPaperWidth)paperWidth
                             ...
                             kickDrawer:(BOOL)kickDrawer invDocNo:(NSString *)invDocNo docType:(NSString *)docType EnableGST:(int)enableGST;

+ (NSData *)PrinLineCollectionLineWithDocType:(NSString *)docType DateFrom:(NSString *)dateFrom DateTo:(NSString *)dateTo;

+ (NSData *)printKitchenReceiptWithPaperWidth:(SMPaperWidth)paperWidth
                                     language:(SMLanguage)language Item:(NSString *)itemName TableName:(NSString *)tbName Qty:(NSString *)qty;
...
+ (void)PrintRasterSampleReceiptWithPortname:(NSString *)portName
                                portSettings:(NSString *)portSettings
                                  paperWidth:(SMPaperWidth)paperWidth
                                    Language:(SMLanguage)language invDocno:(NSString *)invDocNo EnableGst:(int)enableGst KickOutDrawer:(BOOL)kickOutDrawer;

+(void)PrintRasterDailyCollectionWithPortName:(NSString *)portName
                                 portSettings:(NSString *)portSettings
